# Attacking the trained DNNs with or without defense methods with SAP in situation I
...
r1, r2, r3, r4, r5, r6, r7, r8, f1, f2, f3, f4, f5, f6, f7, f8 = success_rate(val_loader, model1, model2, model3, model4, model5, model6, model7, model8, eps = 20, step_alpha = 1,num_steps = 20, sizes = crafting_sizes, weights = crafting_weights)
print("Original model correct rate and f1 score", (r1, f1))
print("ADT correct rate and f1 score", (r2, f2))
