...
def create_data(raw_data = None, raw_labels = None, permutation = None, ratio = None, preprocess = None, max_length = None , augmented = None, padding = 'two'):
    ...
    #train_length = length[:mid]
    #val_length = length[mid:]
